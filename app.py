...
st.markdown('Featuring video games popular in North America, Japan, Europe, and beyond, ' \
...
### long dataset ###
df_long = df.melt(id_vars=['Name', 'Year', 'Platform', 'Platform_Generation', 'Platform_Company','Global_Sales'],
                  var_name = 'Country',
                  value_name='Sales')
...
st.markdown(" - Table 2 is the summary of 9989 video games sales from 1990 to 2017, with average " \
...
st.markdown(" - Table 3 contains 6925 unique game titles across 15 platform generations, " \
...
with scatterplot_section:
    ...
    fig = px.scatter(df,
                     x = 'EU_Sales',
                    y = 'Global_Sales',
                    color=st.session_state['check_opt'])
